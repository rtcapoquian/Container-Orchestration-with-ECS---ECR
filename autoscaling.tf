...
resource "aws_appautoscaling_policy" "frontend_cpu" {
  name               = "${local.project_name}-frontend-cpu-scaling"
...
# Memory-based Auto Scaling Policy for Frontend
resource "aws_appautoscaling_policy" "frontend_memory" {
  name               = "${local.project_name}-frontend-memory-scaling"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.frontend.resource_id
  scalable_dimension = aws_appautoscaling_target.frontend.scalable_dimension
  service_namespace  = aws_appautoscaling_target.frontend.service_namespace
...
# ALB Request Count Auto Scaling Policy for Frontend
resource "aws_appautoscaling_policy" "frontend_requests" {
  name               = "${local.project_name}-frontend-request-scaling"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.frontend.resource_id
  scalable_dimension = aws_appautoscaling_target.frontend.scalable_dimension
  service_namespace  = aws_appautoscaling_target.frontend.service_namespace
...
# ALB Request Count Auto Scaling Policy for Backend
resource "aws_appautoscaling_policy" "backend_requests" {
  name               = "${local.project_name}-backend-request-scaling"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.backend.resource_id
  scalable_dimension = aws_appautoscaling_target.backend.scalable_dimension
  service_namespace  = aws_appautoscaling_target.backend.service_namespace

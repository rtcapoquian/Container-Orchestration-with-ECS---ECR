...
# Database Service Repository (if using containerized DB)
resource "aws_ecr_repository" "database" {
  ...
  tags = merge(local.common_tags, {
    Name        = "${local.project_name}-database-ecr"
...
resource "aws_ecr_repository" "nginx" {
  ...
  tags = merge(local.common_tags, {
    Name        = "${local.project_name}-nginx-ecr"
    ServiceType = "proxy"
  })
}
...
# ECR Repository Policies for CI/CD access

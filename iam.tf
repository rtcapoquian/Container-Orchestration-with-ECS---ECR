# IAM Roles and Policies for ECS and CodePipeline
...
# Custom policy for ECS execution role (for secrets access)
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = [
          ...
          "codedeploy:CreateApplicationRevision",
...
resource "aws_iam_role" "codedeploy_ecs" {
  name = "${local.project_name}-codedeploy-ecs-role"
...
# Additional custom policy for CodeDeploy ECS role
resource "aws_iam_role_policy" "codedeploy_ecs_custom" {
  name = "${local.project_name}-codedeploy-ecs-custom"
...
# Output the CodeDeploy role ARN for use in CodePipeline
output "codedeploy_ecs_role_arn" {
  description = "ARN of the CodeDeploy ECS service role"
